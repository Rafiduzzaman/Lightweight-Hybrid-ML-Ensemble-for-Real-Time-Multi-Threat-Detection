...
\bibitem{cic2018}
CIC, ``CSE-CIC-IDS2018 Dataset,'' Canadian Institute for Cybersecurity, 2018. [Online].
...
\bibitem{zhou2024waf}
J. Zhou, Y. Chen, and H. Liu, ``Machine learning methods for web application firewall detection: A survey,'' \textit{Future Gener. Comput. Syst.}, vol. 156, 2024.

\bibitem{liu2023transfer}
S. Liu, X. Wang, and Y. Zhao, ``Transfer learning and domain adaptation for intrusion detection: A review,'' \textit{IEEE Access}, vol. 11, pp. 98765--98788, 2023.

\bibitem{wang2023imbalanced}
Q. Wang, H. Xu, and Z. Chen, ``Handling class imbalance in intrusion detection with resampling and ensemble methods,'' \textit{Appl. Soft Comput.}, vol. 138, 2023.

\bibitem{kim2024attention}
J. Kim, M. Park, and S. Lee, ``Attention-enhanced ensemble models for network intrusion detection,'' \textit{Expert Syst. Appl.}, vol. 245, 2024.
